...
def main() -> None:
    ...
    parser.add_argument(
        "--up2",
        type=Path,
        default=Path(r"F:\kikuchi-super resolution\20260512_Cu_Area 1_OIM Map 1.up2"),
    )
    parser.add_argument(
        "--map-group",
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path(r"E:\EBSD-projiect\EBSD\outputs\edax_area1_index0_software_projection.png"),
    )
